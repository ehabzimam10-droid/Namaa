# Scope: Implementation Track (Replacement Gen 2)
...
|---|------|-------|-------------|--------|
| 1 | Canvas Rendering Engine | Core isometric mathematical transformations, asset preloading, and static board layout | None | DONE |
| 2 | Upgrade Evolution & Animation | Rendering levels 1-5, transitions, particle effects, and developer testing controls | M1 | DONE |
| 3 | Parent Dashboard & Child Outposts | Castle, walls, child outpost nodes, hover tooltips, and click-to-open-modal integration | M2 | DONE |
| 4 | Final E2E Test Integration | Integration with final E2E test suite, resolving any issues, passing TypeScript checks | M3 | IN_PROGRESS |
